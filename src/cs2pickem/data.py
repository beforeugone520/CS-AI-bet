...
NUMERIC_FIELDS = {
    ...
    "team1_player_form_score": float,
    "team2_player_form_score": float,
    "team1_player_form_trend": float,
    "team2_player_form_trend": float,
    "team1_player_sample_confidence": float,
    "team2_player_sample_confidence": float,
    "player_form_score": float,
    "player_form_trend": float,
    "player_sample_confidence": float,
    "substitute_flag": int,
    "player_sample": int,
    "rating": float,
    "kd": float,
