...
def _fixture_from_team_rows(team1: Mapping[str, Any], team2: Mapping[str, Any], best_of: int) -> Dict[str, Any]:
    ...
    fixture = {
        ...
        "team1_substitute_flag": team1.get("substitute_flag", 0),
        "team2_substitute_flag": team2.get("substitute_flag", 0),
        "team1_player_sample": team1.get("player_sample", 0),
        "team2_player_sample": team2.get("player_sample", 0),
        "team1_player_form_score": team1.get("player_form_score", 0.0),
        "team2_player_form_score": team2.get("player_form_score", 0.0),
        "team1_player_form_trend": team1.get("player_form_trend", 0.0),
        "team2_player_form_trend": team2.get("player_form_trend", 0.0),
        "team1_player_sample_confidence": team1.get("player_sample_confidence", 0.0),
        "team2_player_sample_confidence": team2.get("player_sample_confidence", 0.0),
